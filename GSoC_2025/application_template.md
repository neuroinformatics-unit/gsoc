...
> Copy its content, edit it and [open a PR](https://docs.github.com/en/communities/documenting-your-project-with-wikis/adding-or-editing-wiki-pages) to add your proposal as a markdown file with the following title format:
...
## Project title
Follow the following format for the proposal title: `<Package Name>:<Project Name> (<Your-Name>)`. E.g. "movement: support for Kalman filters (Sofía Miñano)". Please use the same title when you submit your proposal to the GSoC application site!
