...
| **1-2** | - Integrate data loading: Enhance load_poses with chunking for HDF5/CSV efficiency. <br>- Add a sleek Dash progress bar for real-time feedback.<br>- Test with multi-individual datasets (e.g., DeepLabCut .h5). | 25 |
